...
export const providerMappings: ProviderMapping[] = [
  ...
  { Icon: Aws, keywords: [ModelProvider.Aws] },
  { Icon: Baidu, keywords: [ModelProvider.Baidu] },
  { Icon: BaiduCloud, keywords: [ModelProvider.BaiduCloud] },
  ...
  { Icon: Claude, keywords: [ModelProvider.Claude] },
  ...
  { Icon: Qiniu, combineMultiple: 1.1, keywords: [ModelProvider.Qiniu] },
  {
    ...
    Icon: AlibabaCloud,
    combineMultiple: 1.1,
    keywords: [ModelProvider.Qwen, ModelProvider.AlibabaCloud],
  },
  {
    Icon: Stepfun,
    combineMultiple: 0.83,
  ...
  { Icon: Spark, combineMultiple: 0.92, keywords: [ModelProvider.Spark] },
  {
    ...
    keywords: [ModelProvider.FireworksAI, ModelProvider.Fireworks],
  },
  ...
  { Icon: Search1API, combineMultiple: 0.9, keywords: [ModelProvider.Search1API] },
  {
    Icon: Infinigence,
    combineMultiple: 0.8,
    keywords: [ModelProvider.InfiniAI, ModelProvider.Infinigence],
  },
  { Icon: Xinference, combineMultiple: 0.85, keywords: [ModelProvider.Xinference] },
  { Icon: WorkersAI, keywords: [ModelProvider.WorkersAI] },
