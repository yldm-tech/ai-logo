# @yldm-tech/ai-logo-static-png

`Static PNG`

Popular AI / LLM model brand logos as static PNG files. Browse them all at [ailogo.yldm.ai](https://ailogo.yldm.ai).
...
```html
<!-- unpkg -->
<img height="64" src="https://unpkg.com/@yldm-tech/ai-logo-static-png@latest/light/openai.png" />

<!-- npmmirror (aliyun) -->
<img height="64" src="https://registry.npmmirror.com/@yldm-tech/ai-logo-static-png/latest/files/light/openai.png" />
```
