# @yldm-tech/ai-logo-static-svg

`Static SVG`

Popular AI / LLM model brand logos as static SVG files. Browse them all at [ailogo.yldm.ai](https://ailogo.yldm.ai).
...
`icons/` — one file per icon variant, named by lowercased brand slug with no separator: `openai`, `openai-text`, `claudecode`. Multi-word brands are not hyphenated.
...
```html
<!-- unpkg -->
<img height="64" src="https://unpkg.com/@yldm-tech/ai-logo-static-svg@latest/icons/openai.svg" />

<!-- npmmirror (aliyun) -->
<img height="64" src="https://registry.npmmirror.com/@yldm-tech/ai-logo-static-svg/latest/files/icons/openai.svg" />
```
