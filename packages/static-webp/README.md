# @yldm-tech/ai-logo-static-webp

`Static WebP`

Popular AI / LLM model brand logos as static WebP files. Browse them all at [ailogo.yldm.ai](https://ailogo.yldm.ai).
...
`light / dark/` — one file per icon variant, named by lowercased brand slug with no separator: `openai`, `openai-text`, `claudecode`. Multi-word brands are not hyphenated.

Light and dark renders are the same set of names under the two directories.
...
```html
<!-- unpkg -->
<img height="64" src="https://unpkg.com/@yldm-tech/ai-logo-static-webp@latest/light/openai.webp" />

<!-- npmmirror (aliyun) -->
<img height="64" src="https://registry.npmmirror.com/@yldm-tech/ai-logo-static-webp/latest/files/light/openai.webp" />
```
