...
const Icon = memo<RNIconProps>(({ size = 24, style, color = "#000000", ...rest }) => {
  return (
    <Svg
      ...
      {...rest}
    >
      <Path d="M23 8.333h-7.333v7.334H23V8.333z" fill={color} />
      <Path d="M1 1v14.667h7.333V8.333h7.334V1H1z" fill={color} fillOpacity=".33" />
      <Path
        ...
        fill={color}
      />
      <Path d="M23 15.667h-7.333V23H23v-7.333z" fill={color} fillOpacity=".33" />
      <Path d="M15.667 15.667H8.333V23h7.334v-7.333z" fill={color} />
    </Svg>
  );
});

Icon.displayName = "SenseNovaMono";
