    ...
    <Svg height={size} style={style} viewBox="0 0 24 24" width={size} {...rest}>
      ...
      <Defs>
        <LinearGradient gradientUnits="userSpaceOnUse" id={a.id} x1="9.789" x2="13" y1="0" y2="7.5">
          ...
          <Stop offset="100%" stopColor="#9553FF" />
        </LinearGradient>
        <LinearGradient gradientUnits="userSpaceOnUse" id={b.id} x1="19" x2="17" y1="3" y2="10.5">
          ...
          <Stop offset="100%" stopColor="#944DFF" />
        </LinearGradient>
        <LinearGradient gradientUnits="userSpaceOnUse" id={c.id} x1="9" x2="2.5" y1="6.5" y2="8">
          ...
          <Stop offset="100%" stopColor="#E581FF" />
        </LinearGradient>
        <LinearGradient gradientUnits="userSpaceOnUse" id={d.id} x1="1" x2="6" y1="12" y2="16">
          <Stop stopColor="#6C48FF" />
          <Stop offset="30.9%" stopColor="#AA5AFF" />
          <Stop offset="100%" stopColor="#5145FF" />
        </LinearGradient>
        <LinearGradient
        ...
        >
          ...
          <Stop offset="100%" stopColor="#5042FF" />
        </LinearGradient>
        <LinearGradient gradientUnits="userSpaceOnUse" id={f.id} x1="6" x2="11" y1="20.5" y2="19">
          ...
          <Stop offset="100%" stopColor="#483FFF" />
        </LinearGradient>
        <LinearGradient
          gradientUnits="userSpaceOnUse"
          id={g.id}
        ...
        >
          ...
          <Stop offset="47.5%" stopColor="#6049FF" />
          <Stop offset="100%" stopColor="#8466FF" />
        </LinearGradient>
      </Defs>
    </Svg>
  );
