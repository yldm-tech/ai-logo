...
const Icon = memo<RNIconProps>(({ size = 24, style, color = "#000000", ...rest }) => {
  return (
    ...
    >
      <G clipPath="url(#a)">
        <Path d="M9.046 7.104a.527.527 0 110 1.055.527.527 0 010-1.055z" fill={color} />
        <Path d="M15.376 7.104a.528.528 0 110 1.056.528.528 0 010-1.056z" fill={color} />
        <Path
          clipRule="evenodd"
