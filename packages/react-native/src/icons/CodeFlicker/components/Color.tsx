    ...
    >
      ...
      <Defs>
        ...
        >
          ...
          <Stop offset="9%" stopColor="#48EEDD" stopOpacity=".89" />
        ...
        <LinearGradient
          ...
          y2="9.998"
        >
          <Stop offset="1%" stopColor="#32EDDA" />
          <Stop offset="6%" stopColor="#4CEFDE" stopOpacity=".87" />
          ...
          <Stop offset="56.00000000000001%" stopColor="#E6FCFA" stopOpacity=".12" />
...
Icon.displayName = "CodeFlickerColor";
